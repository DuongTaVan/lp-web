            ...
            <div class="image-identity__content--form-search">
                ...
                <div class="table-content">
                    <div class="d-flex justify-content-start align-items-center record">
                        <select id="select-per-page" per-page="{{$data['images']->perPage()}}"
                                current-page="{{$data['images']->currentPage()}}"
                                last-page="{{$data['images']->lastPage()}}" total-record="{{$data['images']->total()}}"
                    ...
                    <div class="table">
                        @include('portal.modules.businessImage.businessListTable')
                    </div>
                    @include('portal.components.table-footer', ['data' => $data['images']])
                </div>
            </div>
        </div>
@endsection
