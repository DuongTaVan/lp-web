...
<div class="mb-13 mt-18 d-flex f-w6 justify-content-between flex-wrap">
    ...
    <div class="wrap-common-3">
        <div class="label-common text-center">その他オプション売上計</div>
        <div class="wrap-content">
            <div class="content d-flex justify-content-center align-items-center">
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                <div class="d-none">
                    {{ $sum = $data['sales']['total_sales'] + $data['sales']['option_sales'] }}
                </div>
                @percent(($data['sales']['total_sales'] - $data['sales']['extension_sales']), $sum)% /
                @percent($data['sales']['extension_sales'], $sum)% /
                @percent($data['sales']['option_sales'], $sum)%
                <div class="text-center">(配信/延長/オプション)</div>
            </div>
        </div>
    </div>
    <div class="wrap-common-3">
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                @money($data['sales']['fortunetelling_applicants_teacher_new'])人 /
                @money($data['sales']['fortunetelling_applicants_teacher_repeater'])人
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                @money($data['sales']['is_fortunetelling'])回 /
                @money($data['sales']['fortunetelling_extension_count'])回
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                @ratio($data['sales']['total_minutes'], $data['sales']['is_fortunetelling'])分
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                ¥@ratio($data['sales']['course_sales'], $data['sales']['is_fortunetelling'])
                <div class="text-center">(延長時間除く)</div>
            </div>
        </div>
    </div>
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                ¥@ratio($data['sales']['extension_sales'], $data['sales']['fortunetelling_extension_count'])
    ...
    <div class="wrap-common-3">
        ...
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                @ratio($data['sales']['minutes_fortunetelling_extended'], $data['sales']['extension_count'])分
    ...
    <div class="wrap-common-3">
        <div class="label-common text-center d-flex flex-column">
            閲覧数
        </div>
        <div class="wrap-content">
            <div class="content d-flex flex-column justify-content-center align-items-center">
                @ratio($data['page_views']['is_fortunetelling'], $data['day_of_month'])PV /
                @money($data['page_views']['is_fortunetelling'])PV
...
<script type="text/javascript">
    window.onload = function () {
        ...
        let app1 = @json($data['chartTelling1']);
        let app2 = @json($data['chartTelling2']);
        let app3 = @json($data['chartTelling3']);
        var positionChart;
        var alignChart;
        var heightChart;
        var widthChart;
        ...
        //Chart 1
        let dataCategory1 = ['タロット占い', '四柱推命', '姓名判断占い・姓名診断', '手相占い', '西洋占星術', '開運・厄払い', '易占い', '風水占い', '霊感占い', '生命学', 'その他'];
        let dataCategory1_1 = [];
        ...
        function drawChart1() {
            ...
            var options = {
                ...
                colors: ['#40aae7', '#d74b90', '#f2664e', '#F1C40F', '#F39C12', '#2ECC71', '#EBDEF0', '#E74C3C', '#633974', '#E74C3C', '#1A5276']
            };
        ...
        //     type: 'pie',
        //     data: {
        //         labels: ['タロット占い', '四柱推命', '姓名判断占い', '手相占い', '西洋占星術', '開運、厄払い', '易占い', '風水占い', '霊感占い', '生命学', 'その他'],
        //         datasets: [{
