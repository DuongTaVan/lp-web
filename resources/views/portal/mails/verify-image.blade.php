...
<div class="student-restock-email">
    ...
    <div class="student-restock-email__course-info">
        <p class="student-restock-email__course-info__title" style="margin: 0"> 【＋新規サービスの作成】はこちら</p>
        <a class="ml-15px" href="{{route('client.teacher.my-page.service-list', 'tab=clone')}}"
           target="_blank">{{route('client.teacher.my-page.service-list', 'tab=clone')}}</a>
        <hr>
    </div>
</div>
