...
<div class="student-restock-email">
    ...
    <div class="student-restock-email__text-note">
        <p style="margin: 0">開催リクエストのサービスが公開されましたのでお知らせいたします。</p>
    ...
    <div class="student-restock-email__course-info">
        ...
        <p style="margin: 0">金額 ： {{number_format($course['price'])}}円</p>
        <p style="margin: 0">金額 ： {{number_format($course['price'])}}円</p>
        <hr>
    </div>

    <div class="student-restock-email__course-info">
        <p class="student-cancel-email__course-info__note-review" style="margin: 0">・リクエストサービスは「サービス詳細ページ」よりご確認できます。</p>
        <p class="student-cancel-email__course-info__item" style="margin: 0">
            <span class="text-title-bold">【詳細ページ】</span>：
            <a href="{{route('client.course-schedules.detail', $course['course_schedule_id'])}}"
               target="_blank">{{route('client.course-schedules.detail', $course['course_schedule_id'])}}</a>
        </p>
        <hr>
    </div>
</div>
