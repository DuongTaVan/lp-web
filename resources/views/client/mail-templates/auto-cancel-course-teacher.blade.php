...
<div class="student-restock-email">
    ...
    <div class="student-restock-email__text-note">
        <p style="margin: 0;">下記開催日サービスのキャンセルが完了しま</p>
        <p style="margin: 0;">したのでご確認ください。</p>
        <hr>
    </div>
    ...
    <div class="student-restock-email__course-info">
        <p style="margin: 0;" class="student-cancel-email__course-info__note-review">・購入者マイページからは「購入中サービス」画面よりご確認下さい。</p>
