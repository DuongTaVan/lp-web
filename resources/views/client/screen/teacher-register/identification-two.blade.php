                    ...
                    <div class="content-item content-item__mb">
                        ...
                        <div class="identification-images {{ (int)$verifyType === 2 ? 'one-image' : '' }}">
                            <div class="position-relative image-container">
                                ...
                                <img src="{{ asset(isset($user['imagePathType1']) ? $user['imagePathType1']->image_url : './assets/img/teacher-page/rectangle.png')}}"
                                     id="image_identify"
                                     class="img-responsive {{ isset($user['imagePathType1']) ? 'img-contain' : '' }}"
                                     alt="Image">
                                <div class="position-absolute image-button @if(isset($user['imagePathType1'])) hidden @endif"
                            ...
                            <div class="position-relative image-container image-container-two"
                                ...
                                <input type="file" class="file1" name="file1" data-name="image_identify1"
                                       ...
                                       accept="image/png, image/gif, image/jpeg">
                                <img src="{{ asset(isset($user['imagePathTypeDisplayOne']) ? $user['imagePathTypeDisplayOne']->image_url : './assets/img/teacher-page/rectangle.png')}}"
                                     id="image_identify1"
                                     class="img-responsive1 {{ isset($user['imagePathTypeDisplayOne']) ? 'img-contain' : '' }}"
                                     alt="Image">
                                <div class="position-absolute image-button1 @if(isset($user['imagePathTypeDisplayOne'])) hidden @endif"
                        ...
                        <div class="note-address">{{ __('labels.teacher_register.identifications.helper_identity_verification') }}</div>
