...
@section('content')
    <div class="inquiry">
        ...
        {{--                <div class="inquiry__content__title__one">お問い合わせの前に、よくあ</div>--}}
        {{--                <div class="inquiry__content__title__two">るご質問をお役立てください。</div>--}}
        ...
        {{--                                パスワード再設定は--}}
        {{--                                @if(auth('client')->user())--}}
        {{--                                    <a target="_blank" href="{{route('client.student.my-page.change-password')}}">こちら</a><img--}}
        ...
        {{--                            </div>--}}
        {{--                            <div class="inquiry__content__option__question__right__black">--}}
        {{--                                キャンセル画面は <a target="_blank" href="{{route('client.student.my-page.order')}}">こちら️</a><img--}}
        {{--                                        src="{{ url('assets/img/payment_method/icon-right-link.png') }}" alt="icon">--}}
        {{--                            </div>--}}
            ...
            <div class="inquiry__form-info__precaution">
                ...
                <div class="inquiry__form-info__precaution__black">
                    <div class="direction-sp">
                        <span>※メールが正しく届かない場合がございますので、【info@lappi-live.com】からのメールの受信許可設定を</span>
                        <span>お願いいたします。</span>
                    </div>
                </div>
                <div class="inquiry__form-info__precaution__black">
