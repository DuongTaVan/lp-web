...
<form class="course" method="POST"
    ...
    <div class="course__content">
        ...
        <div class="wrap-item box-large d-flex">
            ...
            <div class="wrap-item__value">
                ...
                @else
                    ...
                    @endif
                    <div class="error fs-12 error-start-datetime">
        ...
        <div class="wrap-item box-large d-flex">
            ...
            <div class="wrap-item__value">
                <div class="f-w3 d-flex justify-content-between align-items-center preview-box">
                    <div id="list-img" class="d-flex list-img-step-3">
                        @if (session()->has('preview_file_' . auth('client')->id()))
                            @foreach(session('preview_file_' . auth('client')->id()) as $index => $item)
                                <div class="preview preview-{{ $index }}">
                                    <input type="hidden" @if(isset($item['type']) && $item['type'] === 'FILE_OLD') name="previewOld[]" @endif value="{{ json_encode($item) }}">
        ...
        <div class="wrap-item box-min d-flex">
            ...
            <div class="wrap-item__value">
                <textarea name="subtitle" id="subtitle-3"
        ...
        <div class="wrap-item box-large d-flex">
            ...
            <div class="wrap-item__value">
                <textarea name="flow" id="flow-3" placeholder="（例）
                ・自己紹介
                ・予定終了時間の確認
                ・配信画面の説明　（使い方・ご利用方法）
                ・サービス開始
        ...
        <div class="wrap-item box-large d-flex">
            ...
            <div class="wrap-item__value">
                <textarea name="cautions" id="cautions-3" placeholder="（例）
                【必ずお読みください】
            ...
            <div id="collapseExample">
                ...
                <div id="setting-request" class="box-large">
                    <div class="optional-setting__wrap">
                        ...
                        @php
                            $price = $course->subCourse->price ?? null;
                            $minuteRequired = $course->subCourse->minutes_required ?? 0;
                        @endphp
                        ...
                        <div class="optional-setting__item d-flex">
                            ...
                            <div class="optional-setting__item__value">
                                ...
                                <div class="error fs-12 error-sub-price error-sub_course error-price_sub_course">
        ...
        <div class="d-flex wrap-submit justify-content-center action-button">
            ...
            <div class="back-container">
                ...
                <a href="#"
{{--                        href="{{ route('client.teacher.my-page.service-list', ['tab' => ($param['tab'] ?? '') === 'draft' ? 'draft' : ($label['screen'] == 'LIVESTREAM-3' ? 'new' : 'clone')]) }}"--}}
                   id="back-step-livestream"
                   type="button" class="back">戻る</a>
            </div>
            <div class="save-container">
                <button type="submit" style="display: none" name="status" value="{{ \App\Enums\DBConstant::COURSE_STATUS_DRAFT }}"
                        id="save-draft-3"
                        class="save-draft f-w6">{{ __('labels.button.draft_course') }}</button>
                <button type="button"
                        id="step-3-draft"
                        class="save-draft f-w6">{{ __('labels.button.draft_course') }}</button>
                <button type="submit" name="status" style="display: none" value="0" id="btn-submit-3"></button>
...
<script>
  // if (typeof configCkeditor === 'undefined') {
