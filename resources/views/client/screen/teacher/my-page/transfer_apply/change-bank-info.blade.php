                                    ...
                                    <div class="teacher-sidebar-right__table tranfer-apply-livestream">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                ...
                                                <button type="button" class="btn button-apply" data-toggle="modal"
                                    ...
                                    <div class="change-account-setting">
                                        ...
                                        <div class="button-submit">
                                            <button type="button" class="btn button-apply">
                                                @lang('labels.transfer-apply.change-bank-info.button_1')
                                            </button>
                                            <button type="button" class="btn button-apply">
                                                @lang('labels.transfer-apply.change-bank-info.button_2')
                                            </button>
                                        </div>
                                    </div>
                                </div>
