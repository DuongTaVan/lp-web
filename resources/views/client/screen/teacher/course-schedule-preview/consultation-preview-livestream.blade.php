        ...
        <div class="content">
            ...
            <div class="d-flex flex-wrap">
                <div class="col9 content-description">
                    ...
                    <div class="sub-description-title text-left">{!! $course->subtitle  ?? null!!}</div>
                    ...
                    <div class="explain-content">
                                ...
                                <div class="swiper-wrapper">
                                    @if(count($oldImg) > 0)
                                        <div class="swiper-slide family-app__slider ">
                                            <img src='{{Storage::disk('s3')->url($oldImg[0])}}' alt=""
                                                 width="900"
                                                 height="497">
                                        </div>
                                    ...
                                    @elseif(count($previews) > 0)
                                        <div class="swiper-slide family-app__slider ">
                                            <img src='{{$previews[0]}}' alt="" width="900"
                                                 height="497">
                                        </div>
                        ...
                        <div class="explain-content__option-btn position-relative">
                            ...
                            @else
                                <a href="{{url()->previous()}}" class="explain-content__option-btn__edit">戻る</a>
                            @endif
                            @if(auth('client')->user()->user_status === \App\Enums\Constant::USER_STATUS_REST)
                                <form method="POST"
                                      action="{{route('client.teacher.courses.update.public-course-schedule.video-call', $courseSchedule->course_schedule_id)}}">
                                    @csrf
                                    ...
                                    <input type="hidden" value="{{$course->subtitle}}" name="subtitle">
                                    <input type="hidden" value="{{$course->body}}" name="body">
                                    <input type="hidden" value="{{$course->flow}}" name="flow">
                                    <input type="hidden" value="{{$course->cautions}}" name="cautions">
                                    <input type="hidden" value="{{$course->is_mask_required}}" name="is_mask_required">
...
{{--                                    <input type="hidden" name="imageId" value="{{$imageId}}">--}}
                                    ...
                                    <input type="hidden" name="subCourseScheduleDraft" value="subCourseScheduleDraft">
                ...
                <div class="col3 content-table">
                    <div class="Admission-fee">
                        ...
                        <div class="option-list text-left">
                            ...
                            <div
                                    class="rectangle d-flex flex-column justify-content-center align-items-center position-relative choose-option-preview choose-option active">
                    ...
                    <div class="seller-profile">
                        <div class="seller-profile__header text-center position-relative">
                            ...
                            <p class="seller-profile__header--cat">{{ $user->full_name }}</p>
                            @if((int)$course->is_mask_required === 0)
                                <div class="formality fs-12 fw-600">
                                    @lang('labels.course-detail.formality')
                                    <span>(OK)</span>
                                </div>
