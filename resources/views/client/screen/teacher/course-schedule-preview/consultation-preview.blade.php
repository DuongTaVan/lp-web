...
{{--                        @endif--}}
                        ...
                        {{--                  Slider image sp--}}
                        @if($sessionImage && $iMax)
                            <div class="family-app">
                                <div class="swiper-container mySwiper">
                                    <div class="swiper-wrapper">
                                        @foreach($sessionImage as $img)
                        ...
                        @if(isset($courseChildren) && count($courseChildren)> 0)
                        ...
                        <div class="explain-content__option-btn position-relative">
                            ...
                            @if(auth('client')->user()->user_status === \App\Enums\Constant::USER_STATUS_REST)
                                <form method="POST"
                                    ...
                                    <input type="hidden" value="{{$courseSchedule->subtitle}}"
                                           name="subtitle" class="hidden_input">
                                    <input type="hidden" value="{{$courseSchedule->body}}"
                                           name="body" class="hidden_input">
                                    <input type="hidden" value="{{$courseSchedule->flow}}"
                                           name="flow" class="hidden_input">
                                    <input type="hidden" value="{{$courseSchedule->cautions}}"
                                           name="cautions" class="hidden_input">
                                    <input type="hidden" value="{{$courseSchedule->is_mask_required}}"
                                           name="is_mask_required" class="hidden_input">
