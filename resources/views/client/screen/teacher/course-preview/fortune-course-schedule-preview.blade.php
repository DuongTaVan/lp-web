        ...
        <div class="content">
            ...
            <div class="d-flex flex-wrap">
                <div class="col9 content-description">
                    <p class="description-title f-w6 text-left">{{ $courseSchedule->title }}</p>
                    ...
                    <div class="explain-content">
                        ...
                        <div class="explain-content__option-btn">
                            ...
                            @if(auth('client')->user()->user_status === \App\Enums\Constant::USER_STATUS_REST)
                                <form method="POST"
                                      action="{{route('client.teacher.courses.update.public-course-schedule-edit.fortunetelling', $courseSchedule->course_schedule_id)}}">
                                    @csrf
                                    ...
                                    @if(count($extraTitle) > 0)
                                        @foreach($extraTitle as $ex)
                                            <input type="hidden" class="f-w3 input-small" placeholder=""
                                                   value="{{$ex}}" name="extra_title[]">
                                        @endforeach
                                    @else
                                        <input type="hidden" class="f-w3 input-small" placeholder=""
                                               value="" name="extra_title[]">
                                    @endif
                                    @if(count($extraPrice) > 0)
                                        @foreach($extraPrice as $ep)
                                            <input type="hidden" class="f-w3 input-small" placeholder=""
                                                   value="{{$ep}}" name="extra_price[]">
                                        @endforeach
                                    @else
                                        <input type="hidden" class="f-w3 input-small" placeholder=""
                                               value="" name="extra_price[]">
                                    @endif
...
{{--                            @elseif($course->optionalExtras->count() > 0)--}}
{{--                                <section id="charged-option">--}}
{{--                                    <div id="option-schedule"--}}
{{--                                         class="charged-option d-flex justify-content-center align-items-center">--}}
{{--                                        <img src="{{asset('assets/img/clients/course-detail/circle-plus.svg')}}"--}}
