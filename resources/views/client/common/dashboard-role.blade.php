<!-- @if(auth('client')->user()->user_type == \App\Enums\DBConstant::USER_TYPE_TEACHER)
    <div class="tab-head tab-head-main d-flex">
        <a href="{{route('client.student.my-page.dashboard')}}"
           class="tab-head-left d-flex justify-content-center align-items-center">
            <div class=" link-left">
                購入者マイページ
            </div>
        </a>
        <a href="{{route('client.teacher.my-page.dashboard')}}"
           class="tab-head-right d-flex justify-content-center align-items-center">
