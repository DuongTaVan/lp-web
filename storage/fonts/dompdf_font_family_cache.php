...
return array (
  ...
  'hiragino-kaku-gothic-pron-w3' => array(
    'normal' => $fontDir . '/hiragino-kaku-gothic-pron-w3',
    'bold' => $fontDir . '/hiragino-kaku-gothic-pron-w3',
    'italic' => $fontDir . '/hiragino-kaku-gothic-pron-w3',
    'bold_italic' => $fontDir . '/hiragino-kaku-gothic-pron-w3',
  ),
  't?estfont' => array(
    'normal' => $fontDir . '/hiragino-kaku-gothic-pro-w3',
    'bold' => $fontDir . '/hiragino-kaku-gothic-pro-w3',
    'italic' => $fontDir . '/hiragino-kaku-gothic-pro-w3',
    'bold_italic' => $fontDir . '/hiragino-kaku-gothic-pro-w3',
  ),
  'meiryo' => array(
    'normal' => $fontDir . '/meiryo',
    'bold' => $fontDir . '/meiryo',
    'italic' => $fontDir . '/meiryo',
    'bold_italic' => $fontDir . '/meiryo',
  ),
);
}; ?>